...
// sampling range ����
/* GRAD_LENGTH must be the RAW gradient magnitude — do NOT pass a value with a normalization epsilon
   ...
   hlsl/vxgi/Voxelize.hlsl, which bakes this very term into the VXGI coverage for VR_MODE 2 — the two
