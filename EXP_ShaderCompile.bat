...
fxc /E OIT_ARRAGNGE /T cs_5_0 ./hlsl/kbuf/OitArrange.hlsl /Fo ./shader_compiled_objs/SR_OIT_SORT2RENDER_cs_5_0 /D MAX_LAYERS=8 /D ZF_HANDLING=1
...
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_PHONGBLINN_ps_5_0 /D __RENDERING_MODE=0 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D PIXEL_SYNCH=1 /D USE_ROV=1
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_DASHEDLINE_ps_5_0 /D __RENDERING_MODE=1 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D PIXEL_SYNCH=1 /D USE_ROV=1 
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_MULTITEXTMAPPING_ps_5_0 /D __RENDERING_MODE=2 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D PIXEL_SYNCH=1 /D USE_ROV=1 
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_TEXTMAPPING_ps_5_0 /D __RENDERING_MODE=3 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D PIXEL_SYNCH=1 /D USE_ROV=1
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_TEXTUREIMGMAP_ps_5_0 /D __RENDERING_MODE=4 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D PIXEL_SYNCH=1 /D USE_ROV=1 

fxc /E SINGLE_LAYER /T ps_5_0 ./hlsl/kbuf/Sr_Common.hlsl /Fo ./shader_compiled_objs/SR_SINGLE_LAYER_ps_5_0
fxc /E OIT_PRESET /T cs_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_PRESET_cs_5_0 /D ZF_HANDLING=1 /D TAIL_HANDLING=1 /D MAX_LAYERS=8 /D SILHOUETTE_EDGE=1 /D PIXEL_SYNCH=0 /D USE_ROV=1
...
fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_PHONGBLINN_ps_5_0 /D __RENDERING_MODE=0 /D ZF_HANDLING=0 /D TAIL_HANDLING=0 /D MAX_LAYERS=8 /D USE_ROV=0
fxc /E OIT_ARRAGNGE /T cs_5_0 ./hlsl/kbuf/OitArrange.hlsl /Fo ./shader_compiled_objs/SR_OIT_SORT2RENDER_cs_5_0 /D MAX_LAYERS=8 /D ZF_HANDLING=0
...
//fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_PHONGBLINN_ps_5_0 /D __RENDERING_MODE=0 /D ZF_HANDLING=1 /D TAIL_HANDLING=1
//fxc /E OIT_ARRAGNGE /T cs_5_0 ./hlsl/kbuf/OitArrange.hlsl /Fo ./shader_compiled_objs/SR_OIT_SORT2RENDER_cs_5_0 /D MAX_LAYERS=8 /D ZF_HANDLING=1
//fxc /E SINGLE_LAYER /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_SINGLE_LAYER_ps_5_0 /D ZF_HANDLING=1 /D TAIL_HANDLING=1
//fxc /E OIT_PRESET /T cs_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_PRESET_cs_5_0 /D __INTERLOCK=0 /D ZF_HANDLING=1 /D TAIL_HANDLING=1
//
//
//fxc /E OIT_KDEPTH /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_KDEPTH_PHONGBLINN_ps_5_0 /D __RENDERING_MODE=0 /D ZF_HANDLING=0 /D TAIL_HANDLING=0
//fxc /E OIT_ARRAGNGE /T cs_5_0 ./hlsl/kbuf/OitArrange.hlsl /Fo ./shader_compiled_objs/SR_OIT_SORT2RENDER_cs_5_0 /D MAX_LAYERS=8 /D ZF_HANDLING=0
//fxc /E SINGLE_LAYER /T ps_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_SINGLE_LAYER_ps_5_0 /D ZF_HANDLING=0 /D TAIL_HANDLING=0
//fxc /E OIT_PRESET /T cs_5_0 ./hlsl/kbuf/OitSr.hlsl /Fo ./shader_compiled_objs/SR_OIT_PRESET_cs_5_0 /D __INTERLOCK=0 /D ZF_HANDLING=0 /D TAIL_HANDLING=0
