...
#define VRETURN(v, ERR) if(v != S_OK) { cout << #ERR << endl; goto ERROR_PRESETTING; }
		...
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11010), "SR_OIT_KDEPTH_PHONGBLINN_ps_5_0", "ps_5_1"), SR_OIT_KDEPTH_PHONGBLINN_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11011), "SR_OIT_KDEPTH_DASHEDLINE_ps_5_0", "ps_5_0"), SR_OIT_KDEPTH_DASHEDLINE_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11012), "SR_OIT_KDEPTH_MULTITEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_KDEPTH_MULTITEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11013), "SR_OIT_KDEPTH_TEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_KDEPTH_TEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11014), "SR_OIT_KDEPTH_TEXTUREIMGMAP_ps_5_0", "ps_5_0"), SR_OIT_KDEPTH_TEXTUREIMGMAP_ps_5_0);
		...
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA21000), "SR_OIT_SORT2RENDER_cs_5_0", "cs_5_0"), SR_OIT_SORT2RENDER_cs_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA21001), "SR_OIT_PRESET_cs_5_0", "cs_5_0"), SR_OIT_PRESET_cs_5_0);
