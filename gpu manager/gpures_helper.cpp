...
#define VRETURN(v, ERR) if(v != S_OK) { cout << #ERR << endl; goto ERROR_PRESETTING; }
		...
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11010), "SR_OIT_FILL_SKBZT_PHONGBLINN_ps_5_0", "ps_5_0"), SR_OIT_FILL_SKBZT_PHONGBLINN_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11011), "SR_OIT_FILL_SKBZT_DASHEDLINE_ps_5_0", "ps_5_0"), SR_OIT_FILL_SKBZT_DASHEDLINE_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11012), "SR_OIT_FILL_SKBZT_MULTITEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_FILL_SKBZT_MULTITEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11013), "SR_OIT_FILL_SKBZT_TEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_FILL_SKBZT_TEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11014), "SR_OIT_FILL_SKBZT_TEXTUREIMGMAP_ps_5_0", "ps_5_0"), SR_OIT_FILL_SKBZT_TEXTUREIMGMAP_ps_5_0);
		...
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11110), "SR_OIT_FILL_DKBZT_PHONGBLINN_ps_5_0", "ps_5_0"), SR_OIT_FILL_DKBZT_PHONGBLINN_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11111), "SR_OIT_FILL_DKBZT_DASHEDLINE_ps_5_0", "ps_5_0"), SR_OIT_FILL_DKBZT_DASHEDLINE_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11112), "SR_OIT_FILL_DKBZT_MULTITEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_FILL_DKBZT_MULTITEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11113), "SR_OIT_FILL_DKBZT_TEXTMAPPING_ps_5_0", "ps_5_0"), SR_OIT_FILL_DKBZT_TEXTMAPPING_ps_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA11114), "SR_OIT_FILL_DKBZT_TEXTUREIMGMAP_ps_5_0", "ps_5_0"), SR_OIT_FILL_DKBZT_TEXTUREIMGMAP_ps_5_0);
		...
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA21003), "SR_SINGLE_LAYER_TO_SKBZT_cs_5_0", "cs_5_0"), SR_SINGLE_LAYER_TO_SKBZT_cs_5_0);
		VRETURN(register_shader(MAKEINTRESOURCE(IDR_RCDATA21004), "SR_SINGLE_LAYER_TO_DKBZT_cs_5_0", "cs_5_0"), SR_SINGLE_LAYER_TO_DKBZT_cs_5_0);
